                        ...
                        <div className="card">
                            ...
                            <div className="card__side card__side--back card__side--back-1">
                                <div className="card__cta">
                                    ...
                                    <a href="#popup" className="btn btn--white" data-value1={this.articles[i].id} onClick={this.handleSubmitResult}>Подробнее</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    {i + 1 <= this.articles.length - 1 ?
                    <div className="col-1-of-3">
                        <div className="card">
                            ...
                            <div className="card__side card__side--back card__side--back-2">
                                <div className="card__cta">
                                    ...
                                    <a href="#popup" className="btn btn--white" data-value1={this.articles[i].id + 1} onClick={this.handleSubmitResult}>Подробнее</a>
                                </div>
                            </div>
                        </div>
                    </div> : null
                    }
                    { i + 2 <= this.articles.length - 1 ?
                    <div className="col-1-of-3">
                        <div className="card">
                            ...
                            <div className="card__side card__side--back card__side--back-3">
                                <div className="card__cta">
                                    ...
                                    <a href="#popup" className="btn btn--white" data-value1={this.articles[i].id + 2} onClick={this.handleSubmitResult}>Подробнее</a>
                                </div>
                            </div>
                        </div>
                    </div> : null
